...
export default {
  ...
  head() {
    return {
      title: 'Reset your Password | Collegehub Zimbabwe',
      meta: [
        {
          hid: 'description',
          name: 'description',
          content: 'Hurry, reset your password and join thousands of other students on Collegehub.'
        },
      ],
      link: [
        {
          hid: 'canonical',
          rel: 'canonical',
          href: 'https://www.collegehub.co.zw/reset-password/' + this.id
        }
      ],
    }
  }
